      ...
      <div className="max-w-6xl mx-auto">
        ...
        {currentUser && currentUser._id === userId && searchParams.get('preview') === 'true' && (
          <div className="mb-6 p-4 bg-primary/10 border border-primary/50 rounded-xl flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <Link to="/profile" className="px-4 py-2 bg-primary text-dark-900 rounded-lg hover:bg-primary-light transition-colors font-medium">
              Back to My Profile
            </Link>
          </div>
        )}
            ...
            <div className="flex-shrink-0">
              {getSelectedAvatar(user) ? (
                <img 
                  ...
                  alt={user.username} 
                  className="w-32 h-32 rounded-full border-4 border-dark-600 object-cover"
                />
              ) : (
                <div className="w-32 h-32 rounded-full border-4 border-dark-600 bg-dark-700 flex items-center justify-center">
            ...
            <div className="flex-1 min-w-0">
              ...
              {currentUser && currentUser._id !== userId && (
                <div className="mt-6 flex flex-wrap gap-3">
                  ...
                  <Link 
                    to={`/chat/${userId}`} 
                    className="px-6 py-2 rounded-lg font-medium bg-dark-700 text-white border border-dark-600 hover:bg-dark-600 transition-colors flex items-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className={`px-6 py-2 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
                      isBlocked 
                        ...
                        : 'bg-dark-700 text-red-400 border border-dark-600 hover:bg-dark-600'
                    }`}
                  >
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              {user.github && (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center gap-2 px-4 py-2 bg-dark-700 border border-dark-600 rounded-lg text-white hover:bg-dark-600 hover:border-primary transition-colors"
                >
