...
function Profile() {
  ...
  }, [user, isAuthenticated, authLoading, navigate, fetchUserProjects]);
          ...
          <div className="profile-sidebar">
            <div className="stats-card">
              ...
              <div className="stat-item">
                ...
                <span className="stat-value">{userInfo.username}</span>
              </div>
              <div className="stat-item">
                <span className="stat-label">Email</span>
                <span className="stat-value">{userInfo.email}</span>
              </div>
              <div className="stat-item">
        ...
        <div className="profile-section">
          ...
          {projectsLoading ? (
            ...
            <div className="no-projects">
              <p>No projects yet. Upload your first project to showcase your work!</p>
              <button className="upload-first-btn" onClick={() => setShowProjectForm(true)}>
