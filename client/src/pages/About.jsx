    ...
    <div className="min-h-screen bg-neutral-900 py-12 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-12">
          <section className="bg-neutral-800 border border-neutral-600 rounded-lg p-8">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-neutral-800 border border-neutral-600 rounded-lg p-6 hover:border-primary/50 transition-all">
          ...
          <section className="bg-neutral-800 border border-neutral-600 rounded-lg p-8 text-center">
