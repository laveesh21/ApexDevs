...
function Button({ 
  ...
  const baseClasses = 'inline-flex items-center justify-center gap-2 font-medium rounded-lg transition-colors focus:outline-none focus-visible:outline-none disabled:opacity-50 disabled:cursor-not-allowed';
