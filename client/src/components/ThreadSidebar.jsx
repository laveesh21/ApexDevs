...
function ThreadSidebar({ thread, comments, voteScore }) {
  ...
  return (
    <div className="bg-neutral-800/50 border border-neutral-700 rounded-2xl p-6 space-y-4">
      {/* Stats Section */}
      <div>
        <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-4">Thread Stats</h3>
        <div className="space-y-1">
          {/* Author Info */}
          <div className="flex items-center gap-3 pb-3 mb-3 border-b border-neutral-700">
            <AuthorAvatar
          ...
          <div className="flex items-center justify-between py-1">
            ...
            <span className="text-base text-gray-200 font-bold">{voteScore}</span>
          </div>
      ...
      <div className="pt-4 border-t border-neutral-700">
        ...
        <div className="space-y-2">
          <div className="flex items-start gap-2.5">
            <svg className="w-3.5 h-3.5 text-gray-200 mt-0.5 flex-shrink-0" fill="green" viewBox="0 0 20 20">
