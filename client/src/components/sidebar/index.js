 ...
 * - TagFilter: Tag/tech stack multi-select filter
 * 
 * Usage Example:
 * ```jsx
 * import { Sidebar, SidebarSection, SortFilter, TagFilter } from './components/sidebar';
 * 
 * function MyPage() {
 *   return (
 ...
 *         <TagFilter selectedTags={tech} onTagChange={setTech} />
 *       </SidebarSection>
 *     </Sidebar>
 *   );
 * }
...
export { default as TechStackFilter } from './TagFilter';
